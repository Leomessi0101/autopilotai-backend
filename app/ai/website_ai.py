...
IMAGE PLACEHOLDERS:
- Add image placeholders where images would enhance the design
- Use this exact format: <div data-image-slot="hero-main" class="...">Image placeholder text</div>
- Give each placeholder a unique ID (hero-main, about-1, service-img-1, etc.)
- Always include aspect ratio classes (aspect-video, aspect-square, aspect-[4/3])
- Style placeholders with bg-gray-800/50 or similar so they're visible
- Users will upload images to these slots later
            ...
            "html": f"""
                <section class="min-h-screen flex items-center justify-center {bg_class} px-6 py-20">
                    <div class="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div data-image-slot="hero-main" class="aspect-video rounded-2xl bg-gray-800/50 border border-gray-700/50 flex items-center justify-center text-gray-500">
                            <div class="text-center">
                                <svg class="w-16 h-16 mx-auto mb-2 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <p class="text-sm">Click to add image</p>
                            </div>
                        </div>
                    </div>
                </section>
