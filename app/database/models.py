...
class Website(Base):
    ...
    # NEW COLUMNS FOR MASTER ARCHITECT
    html_content = Column(Text, nullable=True)  # ← HTML generated by AI
    content_json = Column(Text, nullable=False)  # metadata, prompt, business_name
    ...
    # Timestamps (PostgreSQL syntax)
    created_at = Column(DateTime, server_default=func.now())
    updated_at = Column(DateTime, server_default=func.now(), onupdate=func.now())  # ← This will work now
